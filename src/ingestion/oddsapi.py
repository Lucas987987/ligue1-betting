"""Étage 1 — Ingestion The Odds API (cotes live Ligue 1).

Interroge l'endpoint /odds de The Odds API pour les matchs Ligue 1 à venir et
capture chaque snapshot de cotes 1X2 (marché h2h, région eu) de façon IMMUABLE :
...
les matchs Ligue 1 à venir. Avec 5 clés × 500 crédits/mois, large marge.
...
_USER_AGENT = "ligue1-betting/0.1 (ingestion oddsapi)"
